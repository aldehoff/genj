...
public class GetIndividualFromIndexMenuAction extends Action2 {
	 ...
	 */
	public GetIndividualFromIndexMenuAction(String menuItem, SosaIndexation  sosaIndexation, Gedcom gedcom) {
