...
public class FeedbackDialog extends JPanel {
	...
	FeedbackDialog(ViewManager setManager) {
...
*/
	...
	private class MailAction extends AbstractAction {
		...
		public void actionPerformed(ActionEvent event) {
				...
				String s = RESOURCES.getString("fb.label.includelog",fileSize);
				...
				jtSubject.grabFocus();
				viewManager.getWindowManager().openWindow("email",
	...
	private class CancelAction extends AbstractAction {
		...
		public void actionPerformed(ActionEvent event) {
			viewManager.getWindowManager().close("email");
		}
	}
	...
	private class CloseAction extends AbstractAction {
		...
		public void actionPerformed(ActionEvent event) {
			viewManager.getWindowManager().close("feedback");
			viewManager.getWindowManager().close("email");
		}
	}
